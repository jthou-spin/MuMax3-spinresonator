...
type RK56resonatortime struct {
}

func (rk *RK56resonatortime) Step() {
	...
	// stage 1
	torqueFn(k1)
	k1i,k1v:=SetResonatorFnNewNew(k1)
	...
	V+=k1v*(1./6.)*Dt32
	torqueFn(k2)
	k2i,k2v:=SetResonatorFnNewNew(k2)
	...
	torqueFn(k3)
	k3i,k3v:=SetResonatorFnNewNew(k3)	
	...
	torqueFn(k4)
	k4i,k4v:=SetResonatorFnNewNew(k4)
	...
	torqueFn(k5)
	k5i,k5v:=SetResonatorFnNewNew(k5)
	...
	torqueFn(k7)
	k7i,k7v:=SetResonatorFnNewNew(k7)
	...
	torqueFn(k8)
	k8i,k8v:=SetResonatorFnNewNew(k8)
	...
	//Update Brf linearly
	time32:=float32(Time)
	if time32 > Tini && time32 < Tfinal{
		Brf=Brfini+(time32-Tini)*Brfchange/(Tfinal-Tini)
	}
...
func (rk *RK56resonatortime) Free() {
}
