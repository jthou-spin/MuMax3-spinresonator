...
GPU accelerated micromagnetic simulator with spin-resonator coupling. The spin dynamics is coupled with an LC resonator which represent the photon mode. The code is modified based on Mumax 3.10. 
